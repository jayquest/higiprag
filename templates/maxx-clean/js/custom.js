...
$(document).ready(function(){
	...
	$('.portfolio-main li').click(function(e) {
		...
		$(".portfolio-content").quicksand($filteredData, {
			...
			duration: 800,
			easing: 'swing',
			enhancement: function() {Cufon.refresh();$(".video-preview,.image-preview,.file-download").mPreviewOverlay();$("*[rel^='prettyPhoto']").prettyPhoto();}
		});
...
$(document).ready(function(){
	...
	*/
	...
	/*preview Overlay*/
	$(".video-preview,.image-preview,.file-download").mPreviewOverlay();
