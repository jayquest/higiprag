# Django settings for higiprag project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('johnny', 'johnnyrox@gmail.com'),
)
...
SECRET_KEY = 'i9xqwa5f#3%cpd&amp;(&amp;5g1n8x=^v-#)h$p_s&amp;qmx4ve#f14@6xo7'
...
ROOT_URLCONF = 'higiprag.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'higiprag.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = ( "django.contrib.auth.context_processors.auth",
                                ...
                                "blog.views.last_posts",
                                "blog.views.parceiros_list",
                                "conteudo.views.paginas_list",
